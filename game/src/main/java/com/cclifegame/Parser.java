...
public class Parser {
    ...
    /**
     * The main parser function. It will read a whole txt file and separate each
     * scenario
     * 
    ...
    public Parser(String filename) {
        ...
        // This line split each scenario by ########################## and store them
        // into a string array.
    ...
    /**
     * A function that read a single scenario and construct it into a scenario
     * object.
     * 
    ...
    public Scenario scenarioFromString(String readString) {
        ...
        // For 2 line after the previous fixed input, scan the result1 stats and the
        // result2 stats.
     ...
     * You start thinking about how maybe a “prestigious” higher education isn’t for
     * you.
    ...
    public static void main(String[] args) {
        Parser ps = new Parser(
                "D:/Personal Folder/Education/Senior/CP222/Life-of-a-CC-Student/CCLifeGame/src/SampleScenario.txt");
